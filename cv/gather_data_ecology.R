...
if(using_googlesheets){
  ...
  position_data <- read_csv2("csvs/positions_eco.csv")
  skills        <- read_csv2("csvs/language_skills.csv")
  text_blocks   <- read_csv2("csvs/text_blocks.csv")
  contact_info  <- read_csv2("csvs/contact_info.csv", skip = 1)
